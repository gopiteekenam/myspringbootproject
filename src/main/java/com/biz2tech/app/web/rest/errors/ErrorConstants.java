...
public final class ErrorConstants {
  ...
  public static final String PROBLEM_BASE_URL = "http://americanfragrances.com/problem";
  ...
  public static final URI INVENTORY_NOT_FOUND_TYPE =
      URI.create(PROBLEM_BASE_URL + "/inventory-not-found");
