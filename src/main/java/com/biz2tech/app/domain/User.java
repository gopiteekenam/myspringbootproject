...
public class User extends AbstractAuditingEntity {
  ...
  public User userAddresses(Set<UserAddress> userAddresses) {
  ...
  public User removeUserAddress(UserAddress userAddress) {
  ...
  public String toString() {
    return "User{" + "login='" + login + '\'' + ", firstName='" + firstName + '\'' + ", lastName='"
        ...
        + ", activated='" + activated + '\'' + ", langKey='" + langKey + '\'' + ", userPhone='"
        + userPhone + '\'' + ", activationKey='" + activationKey + '\'' + "}";
  }
}
