...
import com.biz2tech.app.repository.AuthorityRepository;
...
import com.biz2tech.app.service.util.RandomUtil;
...
public class UserService {
  ...
  public User registerUser(UserDTO userDTO, String password) {
    ...
    //Currently system is designed to accept both user and admin, hence as a temporary fix setting up admin authoritires to the user
  ...
  public Optional<User> getUserWithAuthorities() {
	  ...
	  user = SecurityUtils.getCurrentUserLogin()
		  ...
		  user = userRepository.findOneWithAuthoritiesByLogin("anonymoususer");
	  }
  ...
  public void removeNotActivatedUsers() {
    List<User> users = userRepository
        .findAllByActivatedIsFalseAndCreatedOnBefore(Instant.now().minus(3, ChronoUnit.DAYS));
