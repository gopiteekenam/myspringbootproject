...
public class UserDTO {
  ...
  public UserDTO(User user) {
    ...
    this.createdDate = user.getCreatedOn();
    this.lastModifiedBy = user.getLastUpdatedBy();
    this.lastModifiedDate = user.getLastUpdatedOn();
  ...
  public String toString() {
    return "UserDTO{" + "login='" + login + '\'' + ", firstName='" + firstName + '\''
        ...
        + ", userPhone='" + userPhone + '\'' + ", lastModifiedDate=" + lastModifiedDate
