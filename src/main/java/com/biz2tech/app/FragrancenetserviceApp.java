...
import com.biz2tech.app.config.DefaultProfileUtil;
...
@EnableZuulProxy
public class FragrancenetserviceApp {

  private static final Logger log = LoggerFactory.getLogger(FragrancenetserviceApp.class);

  private final Environment env;

  public FragrancenetserviceApp(Environment env) {
    this.env = env;
  }

  /**
   * Initializes fragrancenetservice.
   * <p>
  ...
  public static void main(String[] args) throws UnknownHostException {
    SpringApplication app = new SpringApplication(FragrancenetserviceApp.class);
