...
import com.biz2tech.app.service.mapper.UserMapper;
...
public class UserResourceIntTest {
  ...
  public void updateUser() throws Exception {
    ...
    managedUserVM.setCreatedDate(updatedUser.getCreatedOn());
    managedUserVM.setLastModifiedBy(updatedUser.getLastUpdatedBy());
    managedUserVM.setLastModifiedDate(updatedUser.getLastUpdatedOn());
    managedUserVM.setAuthorities(Collections.singleton(AuthoritiesConstants.USER));
  ...
  public void testUserDTOtoUser() {
    ...
    assertThat(user.getLastUpdatedOn()).isNotNull();
  ...
  public void testUserToUserDTO() {
    ...
    assertThat(userDTO.getCreatedDate()).isEqualTo(user.getCreatedOn());
    assertThat(userDTO.getLastModifiedBy()).isEqualTo(DEFAULT_LOGIN);
    assertThat(userDTO.getLastModifiedDate()).isEqualTo(user.getLastUpdatedOn());
